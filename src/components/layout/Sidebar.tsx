...
import { LayoutDashboard, Map, Brain, FileText, Settings, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    >
      ...
      {!collapsed && (
        <div className="m-3 p-3 rounded-xl border border-[#1E2D4A] bg-[#0D1526]">
          ...
          <div className="text-xs text-foreground font-medium">{metrics.model_name.replace('Regressor', '')}</div>
